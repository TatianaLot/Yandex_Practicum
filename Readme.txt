...
При построении модели использован случайный подбор наилучшей модели и гиперпараметров по 20 вариациям с использованием кросс-валидации. Подбиралась наилучшая модель из следующего списка: логистическая регрессия, метод опорных векторов, дерево решений, random forest. В качестве метрики качества была выбрана roc_auc_score. В результате наилучшей моделью оказалась модель логистической регрессии. Ее метрика качества составила 91% тренировочной выборке, и 91% на тестовой выборке.
