...
При построении модели использован случайный подбор наилучшей модели и гиперпараметров по 20 вариациям с использованием кросс-валидации. Подбиралась наилучшая модель из следующего списка: логистическая регрессия, метод опорных векторов, метод k ближайших соседей, дерево решений. В качестве метрики качества была выбрана roc_auc_score. В результате наилучшей моделью оказалась модель k ближайших соседей, где оценка принадлежности к классу определяется на основании 27 ближайших соседей (это значений также является подобранным гиепрпараметром). Ее метрика качества составила 91% тренировочной выборке, и 90% на тестовой выборке.
